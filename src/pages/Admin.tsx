...
export default function AdminPage() {
  ...
  const [tournamentFilter, setTournamentFilter] = useState<"all" | "A" | "C">("all");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            ...
            {/* Tournament filter */}
            <div>
              <Label className="text-xs text-muted-foreground mb-2 block">Filtrar por Torneo</Label>
              <div className="flex flex-wrap gap-1.5">
                <Button variant={tournamentFilter === "all" ? "default" : "outline"} size="sm" className="h-8" onClick={() => setTournamentFilter("all")}>Todos</Button>
                <Button variant={tournamentFilter === "A" ? "default" : "outline"} size="sm" className="h-8" onClick={() => setTournamentFilter("A")}>Apertura</Button>
                <Button variant={tournamentFilter === "C" ? "default" : "outline"} size="sm" className="h-8" onClick={() => setTournamentFilter("C")}>Clausura</Button>
              </div>
            </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="w-12">Torneo</TableHead>
                ...
                <TableBody>
                  {loading ? (
                    ...
                    let filtered = roundFilter === "all" ? fixtures : fixtures.filter(f => f.round === roundFilter);
                    filtered = tournamentFilter === "all" ? filtered : filtered.filter(f => f.tournament === tournamentFilter);
                    ...
                    filtered.map((fixture) => (
                      <TableRow key={fixture.id}>
                        ...
                        <TableCell>
                          <Badge variant={fixture.tournament === 'A' ? 'default' : 'secondary'} className="text-[10px] px-1.5">
                            {fixture.tournament === 'A' ? 'APE' : fixture.tournament === 'C' ? 'CLA' : fixture.tournament}
                          </Badge>
                        </TableCell>
